...
import { ref } from 'vue'
import code_str from '@/assets/funcs/computer_sale.js?raw'
import desc_str from '@/assets/funcs/computer_sale.md?raw'
const md = markdownit({
    breaks:true
})
const code = ref(code_str)
const desc = ref(desc_str)
